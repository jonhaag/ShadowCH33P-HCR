...
int time360DomeTurnLeft = 300;  // milliseconds for dome to complete 360 turn at domeAutoSpeed
...
void setup()
{
    ...
    //Maestro Startup Commands - Close doors and arms
